...
ServerAppOption< TYPE > BW_CONFIG_CLASS::NAME( TYPE(),						\
		"", WATCHER_PATH, Watcher::WT_READ_ONLY );

#define BW_OPTION_SETTER_AT( TYPE, NAME, GETTER, SETTER, CONFIG_PATH )		\
	ServerAppOptionGetSet< TYPE > BW_CONFIG_CLASS::NAME( GETTER, SETTER,			\
		CONFIG_PATH #NAME, BW_OPTION_WATCHER_DIR #NAME );

#define BW_OPTION_SETTER( TYPE, NAME, GETTER, SETTER )						\
	BW_OPTION_SETTER_AT( TYPE, NAME, GETTER, SETTER,							\
			BW_CONFIG_PREFIX BW_COMMON_PREFIX )
