...
typedef NTSTATUS (WINAPI *PFND3DKMT_OPENADAPTERFROMDEVICENAME)(__inout D3DKMT_OPENADAPTERFROMDEVICENAME *);
typedef NTSTATUS (WINAPI *PFND3DKMT_CLOSEADAPTER)(__in const D3DKMT_CLOSEADAPTER *);
typedef NTSTATUS (WINAPI *PFND3DKMT_QUERYSTATISTICS)(__in const D3DKMT_QUERYSTATISTICS *);
