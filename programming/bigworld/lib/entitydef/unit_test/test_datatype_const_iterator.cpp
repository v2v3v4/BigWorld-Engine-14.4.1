...
public:
	...
	{
		RETURN_ON_FAIL_CHECK( iter_ != pType_->end() );
...
public:
	...
	TEST_SUB_FUNCTOR_OPERATOR
	{
		...
		DataType::const_iterator it = pType_->begin();
		TEST_SUB_FUNCTOR( IteratorCheck( it, pType_, typeStr_ ) );
		RETURN_ON_FAIL_CHECK( it != pType_->end() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_basic_fixed_size_types )
{
...
TEST_F( EntityDefUnitTestHarness,
	DataType_const_iterator_basic_variable_size_types )
{
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_USER_TYPE_1 )
{
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_implementedBy_1 )
{
	const BW::string userTypeStr(
		"<Type> FIXED_DICT "
	...
	DataType::const_iterator it = pType->begin();
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_IB_1", 2 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_1 )
{
	const BW::string fixedDictStr(
		...
		"<TypeName> TestFD1 </TypeName> </Type>" );
	...
	DataType::const_iterator it = pType->begin();
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD1", 3 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK_EQUAL( pType, &it->getType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_2 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<fixedDictField1> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> false </AllowNone> "
				"<TypeName> TestFD2_A </TypeName> </Type> "
			"</fixedDictField1> "
			"<fixedDictField2> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> false </AllowNone> "
				"<TypeName> TestFD2_B </TypeName> </Type> "
			"</fixedDictField2> "
		"</Properties> <AllowNone> false </AllowNone> "
		"<TypeName> TestFD2 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	...
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD2", 2 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD2_A", 3 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD2_B", 3 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_3 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<int8Field1>		<Type>	INT8	</Type>	</int8Field1> "
		...
		"<TypeName> TestFD3 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	DataType::const_iterator it = pType->begin();
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD3", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK_EQUAL( pType, &it->getType() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_4 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<fixedDictField1> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD4_A </TypeName> </Type> "
			"</fixedDictField1> "
			"<fixedDictField2> <Type> FIXED_DICT <Properties> "
				"<int8Field1>		<Type>	INT8	</Type>	</int8Field1> "
				"<int8Field2>		<Type>	INT8	</Type>	</int8Field2> "
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD4_B </TypeName> </Type> "
			"</fixedDictField2> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD4 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD4", 2,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD4_A", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD4_B", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_5 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<int8Field1>		<Type>	INT8	</Type>	</int8Field1> "
			...
			"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD5 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	DataType::const_iterator it = pType->begin();
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD5", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK_EQUAL( pType, &it->getType() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_6 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<fixedDictField1> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD6_A </TypeName> </Type> "
			"</fixedDictField1> "
			"<fixedDictField2> <Type> FIXED_DICT <Properties> "
				"<int8Field1>		<Type>	INT8	</Type>	</int8Field1> "
				"<int8Field2>		<Type>	INT8	</Type>	</int8Field2> "
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD6_B </TypeName> </Type> "
			"</fixedDictField2> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD6 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD6", 2,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD6_A", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD6_B", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_7 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<fixedDictField1> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD7_A </TypeName> </Type> "
			"</fixedDictField1> "
			"<fixedDictField2> <Type> FIXED_DICT <Properties> "
				"<int8Field1>		<Type>	INT8	</Type>	</int8Field1> "
				"<int8Field2>		<Type>	INT8	</Type>	</int8Field2> "
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD7_B </TypeName> </Type> "
			"</fixedDictField2> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD7 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD7", 2,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_nonPersistentint_1 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			...
			"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
		"</Properties> <AllowNone> false </AllowNone> "
		"<TypeName> TestFD_NP_1 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( 6, pType->streamSize() );
	...
	DataType::const_iterator it = pType->begin();
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_1", 3 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK_EQUAL( pType, &it->getType() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_nonPersistentint_2 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<fixedDictField1> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> false </AllowNone> "
				"<TypeName> TestFD_NP_2_A </TypeName> </Type> "
			"</fixedDictField1> "
			"<fixedDictField2> <Type> FIXED_DICT <Properties> "
				"<int8Field1>		<Type>	INT8	</Type>	"
					"<Persistent> false </Persistent> </int8Field1> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> false </AllowNone> "
				"<TypeName> TestFD_NP_2_B </TypeName> </Type> "
			"</fixedDictField2> "
		"</Properties> <AllowNone> false </AllowNone> "
		"<TypeName> TestFD_NP_2 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( 12, pType->streamSize() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_2", 2 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_2_A", 3 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_2_B", 3 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_nonPersistentint_3 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<int8Field1>		<Type>	INT8	</Type>	"
			...
			"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD_NP_3 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	DataType::const_iterator it = pType->begin();
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_3", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK_EQUAL( pType, &it->getType() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_nonPersistentint_4 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<fixedDictField1> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD_NP_4_A </TypeName> </Type> "
			"</fixedDictField1> "
			"<fixedDictField2> <Type> FIXED_DICT <Properties> "
				"<int8Field1>		<Type>	INT8	</Type>	"
					"<Persistent> false </Persistent> </int8Field1> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD_NP_4_B </TypeName> </Type> "
			"</fixedDictField2> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD_NP_4 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_4", 2,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_4_A", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_4_B", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_nonPersistentint_5 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<int8Field1>		<Type>	INT8	</Type>	"
			...
			"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD_NP_5 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	DataType::const_iterator it = pType->begin();
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_5", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK_EQUAL( pType, &it->getType() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_nonPersistentint_6 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<fixedDictField1> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD_NP_6_A </TypeName> </Type> "
			"</fixedDictField1> "
			"<fixedDictField2> <Type> FIXED_DICT <Properties> "
				"<int8Field1>		<Type>	INT8	</Type>	"
					"<Persistent> false </Persistent> </int8Field1> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD_NP_6_B </TypeName> </Type> "
			"</fixedDictField2> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD_NP_6 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_6", 2,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_6_A", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_6_B", 3,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_nonPersistentint_7 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			"<fixedDictField1> <Type> FIXED_DICT <Properties> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD_NP_7_A </TypeName> </Type> "
			"</fixedDictField1> "
			"<fixedDictField2> <Type> FIXED_DICT <Properties> "
				"<int8Field1>		<Type>	INT8	</Type>	"
					"<Persistent> false </Persistent> </int8Field1> "
				...
				"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
				"</Properties> <AllowNone> true </AllowNone> "
				"<TypeName> TestFD_NP_7_B </TypeName> </Type> "
			"</fixedDictField2> "
		"</Properties> <AllowNone> true </AllowNone> "
		"<TypeName> TestFD_NP_7 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_NP_7", 2,
			/* isNoneAble */ true ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_fixed_ARRAY_1 )
{
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_fixed_ARRAY_2 )
{
	const BW::string arrayStr(
		"<Type> ARRAY <of> "
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_ARRAY_1 )
{
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_ARRAY_2 )
{
	const BW::string arrayStr( "<Type> ARRAY <of> INT8 </of> </Type>" );
	DataTypePtr pType = getDT( arrayStr );
	RETURN_ON_FAIL_CHECK( pType );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_ARRAY_3 )
{
	const BW::string arrayStr(
		"<Type> ARRAY <of> "
			"ARRAY <of> INT8 </of> "
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_fixed_ARRAY_persistAsBlob_1 )
{
	const BW::string arrayStr(
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_fixed_ARRAY_persistAsBlob_2 )
{
	const BW::string arrayStr(
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_ARRAY_persistAsBlob_1 )
{
	const BW::string arrayStr(
		"<Type> ARRAY <of> INT8 </of> "
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_ARRAY_persistAsBlob_2 )
{
	const BW::string arrayStr(
		"<Type> ARRAY <of> INT8 </of> "
			"<persistAsBlob> true </persistAsBlob> </Type>" );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_ARRAY_persistAsBlob_3 )
{
	const BW::string arrayStr(
		"<Type> ARRAY <of> ARRAY <of> INT8 </of> "
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_fixed_TUPLE_1 )
{
	const BW::string arrayStr(
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_fixed_TUPLE_2 )
{
	const BW::string arrayStr(
		"<Type> TUPLE <of> "
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_TUPLE_1 )
{
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_TUPLE_2 )
{
	const BW::string arrayStr( "<Type> TUPLE <of> INT8 </of> </Type>" );
	DataTypePtr pType = getDT( arrayStr );
	RETURN_ON_FAIL_CHECK( pType );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_TUPLE_3 )
{
	const BW::string arrayStr(
		"<Type> TUPLE <of> "
			"TUPLE <of> INT8 </of> "
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_fixed_TUPLE_persistAsBlob_1 )
{
	const BW::string arrayStr(
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_fixed_TUPLE_persistAsBlob_2 )
{
	const BW::string arrayStr(
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_TUPLE_persistAsBlob_1 )
{
	const BW::string arrayStr(
		"<Type> TUPLE <of> INT8 </of> "
			"<persistAsBlob> true </persistAsBlob> </Type>" );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_TUPLE_persistAsBlob_2 )
{
	const BW::string arrayStr(
		"<Type> TUPLE <of> INT8 </of> "
			"<persistAsBlob> true </persistAsBlob> </Type>" );
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_variable_TUPLE_persistAsBlob_3 )
{
	const BW::string arrayStr(
		"<Type> TUPLE <of> TUPLE <of> INT8 </of> "
			"<persistAsBlob> true </persistAsBlob> </of> "
...
TEST_F( EntityDefUnitTestHarness, DataType_const_iterator_FIXED_DICT_and_ARRAY_1 )
{
	const BW::string fixedDictStr(
		"<Type> FIXED_DICT <Properties> "
			...
			"<float32Field1>	<Type>	FLOAT32	</Type>	</float32Field1> "
		"</Properties> <AllowNone> false </AllowNone> "
		"<TypeName> TestFD_and_ARRAY_1 </TypeName> </Type>" );
	DataTypePtr pType = getDT( fixedDictStr );
	RETURN_ON_FAIL_CHECK( pType );
	CHECK_EQUAL( -1, pType->streamSize() );
	...
	// FixedDictStartStreamElement
	TEST_SUB_FUNCTOR_LINENO(
		IteratorCheck( it, pType, "FIXED_DICT", "TestFD_and_ARRAY_1", 4 ) );
	RETURN_ON_FAIL_CHECK( it != pType->end() );
	CHECK( !it->isVariableSizedType() );
	CHECK_EQUAL( pType, &it->getType() );
