...
#if defined(_WIN64)
#pragma warning(disable : 4267) // return, conversion from T to T, possible loss of data
#endif
...
// disable _WIN32_WINNT override if existing version is higher than required one
// this is necessary to prevent compile error if we define both NTDDI_VERSION and _WIN32_WINNT
// which have to match
// and we have to define both of them to get pythons-as-source working
