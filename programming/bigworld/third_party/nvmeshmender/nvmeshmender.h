...
class MeshMender
{
	...
	public:
		...
		enum NormalCalcOption{ DONT_CALCULATE_NORMALS , CALCULATE_NORMALS, 
			DONT_CALCULATE_NORMALS_OR_BINORMALS };
		...
		bool Mend( 		  BW::vector< Vertex >&    theVerts,
						  BW::vector< unsigned int >& theIndices,
	...
	protected:
		...
		void SetUpData(	BW::vector< Vertex >&			theVerts,
						BW::vector< unsigned int >&		theIndices,
						BW::vector< unsigned int >& mappingNewToOldVert,
		...
		typedef BW::vector<TriID> TriangleList;
		...
		//eachother
		typedef BW::vector<TriangleList > NeighborGroupList;
		...
		void UpdateTheIndicesWithFinalIndices(BW::vector< unsigned int >& theIndices );

		void FixCylindricalWrapping(	BW::vector< Vertex >& theVerts , 
										BW::vector< unsigned int >& theIndices,
										BW::vector< unsigned int >& mappingNewToOldVert);
