...
#if defined(_WIN64)
#pragma warning(disable : 4244) // initialising, conversion from T to T, possible loss of data
...
dtStatus dtNavMesh::init(const dtNavMeshParams* params)
{
	...
	m_saltBits = dtMin((size_t)(sizeof(dtTileRef) * 8 - 1), sizeof(dtTileRef) * 8 - m_tileBits - m_polyBits);
	if (m_saltBits < 10)
