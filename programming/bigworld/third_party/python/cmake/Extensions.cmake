...
function(add_python_extension name)
    ...
    IF(${ADD_PYTHON_EXTENSION_BUILTIN} OR BUILTIN_${upper_name})
	...
	ELSE()
	    option(BUILTIN_${upper_name}
    	       "If this is set the \"${name}\" extension will not be compiled in to libpython"
        	   OFF
	    )
	ENDIF()
    ...
    elseif(WIN32 AND NOT BUILD_SHARED)
        ...
        set(extensions_disabled "${extensions_disabled}${name} (Not enabled);"
             CACHE INTERNAL "" FORCE)
